...
\node (vasp) [process1, right of=matsdp,yshift=4.3cm] {vasp module};
...
\node (vasp_default) [process1, below of=vasp_write] {vasp\_default};
...
\node (vasp_analyze_sub) [process2, right of=vasp_analyze] {nn\_map\\estruct\\overlap\_peak\_analyzer\\job\_status};
\node (vasp_write_sub) [process2, right of=vasp_write] {write\_poscar\\ \_with\_atom\_property\\write\_poscar\\ \_with\_force};

...
\node (vasp_build_sub) [process2, right of=vasp_build] {substitution\\rep\_elmt\\selection\_sphere\\orientation\\align\\transform\\create\_supercell\\build\_vacuum\_layer\\exfoliation};
